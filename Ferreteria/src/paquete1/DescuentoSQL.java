...
public class DescuentoSQL extends ConexionSQL{
    ...
    public Descuento ingresarDescuennto(int descuento_ClienteFrecuente, double minCompra, int descuento_volumen){
        ...
        try {
            ...
            st = conexion.createStatement();
            String sql1 = "select * from descuento where id_descuento =  (SELECT id_descuento FROM public.descuento ORDER BY id_descuento DESC LIMIT 1);";
    ...
    //Actulizar Direccion
    public void actualizarDescuento(int id_descuento,int descuento_ClienteFrecuente, double minCompra, int descuento_volumen){
        try{         
            Connection conexion = conectar();
    ...
    //Eliminar direccion
    public void eliminarDescuento(int id_descuento){
        try{
            Connection conexion = conectar();
            st = conexion.createStatement();
