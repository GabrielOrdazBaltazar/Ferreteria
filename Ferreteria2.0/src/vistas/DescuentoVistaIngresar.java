 ...
 * @author tachy
 */
public class DescuentoVistaIngresar extends javax.swing.JFrame {

    /**
     * Creates new form DescuentoVistaIngresar
     */
    public DescuentoVistaIngresar() {
        initComponents();
    }
    ...
    private void initComponents() {
      ...
      //Validacion Descuento Cliente Frecuente
        ...
        btnBuscarDescuento.setText("Buscar Descuento");
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(txtDescuentoClienteFrecuente)
                                    .addComponent(txtMinCompra)
                                    .addComponent(txtDescuentoVolumen, javax.swing.GroupLayout.DEFAULT_SIZE, 133, Short.MAX_VALUE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        paquete1.Descuento des = new paquete1.Descuento(descuentoClienteFrecuente,minCompra,descuentoVolumen);
        jResultado.setText(des.getResultado());
        //Limpiar
    ...
    private void btnBuscarDescuentoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarDescuentoActionPerformed
        DescuentoVistaBuscar vbdes = new DescuentoVistaBuscar();
        vbdes.setVisible(true);
        vbdes.setLocationRelativeTo(null);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DescuentoVistaIngresar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DescuentoVistaIngresar().setVisible(true);
            }
        });
    }
